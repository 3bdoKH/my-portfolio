...
const RecentProjects = () => {
    ...
    //     window.location.replace(projects[id].link)
    // }
    return (
        <div className='py-20' id='projects'>
            ...
            <div className="flex flex-wrap justify-center items-center p-4 gap-x-24 gap-y-8 mt-10">
                {projects.map(({ id, title, des, img, iconLists, link }) => (
                    <div key={id} className='sm:h-[46rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw] max-sm:h-[38rem]' >
                        <PinContainer
                            title={link}
                            href={link}
                        >
